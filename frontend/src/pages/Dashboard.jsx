...
export default function Dashboard() {
  ...
  const load = async () => {
    try {
      ...
      setSummary(s.data && typeof s.data === 'object' ? s.data : {})
      setKpiCards(Array.isArray(k.data) ? k.data : [])
      setTrend(Array.isArray(t.data) ? t.data.slice(-12) : [])
      setAlerts(Array.isArray(a.data) ? a.data.filter(x => !x.is_read) : [])
    } catch {
